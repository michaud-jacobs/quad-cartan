...
// This code runs on Magma-2.25-3, whereas the file Sieve_NewMagma.m runs on Magma-2.26-2.
...
///////////////////////////////////////////////////////////////////////////////////////////////
    ...
    for i in [1..7] do                  
        ...
        Pinv:=Points(PK @@ phiK);       // Pullback of the point to the top curve (compare with Sieve_NewMagma.m)
        Qa:=Eltseq(Pinv[1]);           
        Qb:=Eltseq(Pinv[2]);             // The two quadratic points
